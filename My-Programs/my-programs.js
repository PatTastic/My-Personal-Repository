...
function getMyPrograms(){
    ...
    program10[2] = "<hr><p>Application Type: Windows Form | Extension: .exe | Language: C# | Size: 15.50KB</p><hr>";
    ...
    program9[2] = "<hr><p>Application Type: Windows Form | Extension: .exe | Language: C# | Size: 15.50KB</p><hr>";
    ...
    program8[2] = "<hr><p>Application Type: Windows Form | Extension: .exe | Language: C# | Size: 21.50KB</p><hr>";
    ...
    program7[2] = "<hr><p>Application Type: Console | Extension: .exe | Language: C++ | Size: 1.27MB</p><hr>";
    ...
    program6[2] = "<hr><p>Application Type: Console | Extension: .exe | Language: C++ | Size: 1.26MB</p><hr>";
    ...
    program5[2] = "<hr><p>Application Type: Console | Extension: .exe | Language: C++ | Size: 1.26MB</p><hr>";
    ...
    program4[2] = "<hr><p>Application Type: Console | Extension: .exe | Language: C++ | Size: 1.25MB</p><hr>";
    ...
    program3[2] = "<hr><p>Application Type: Console | Extension: .exe | Language: C++ | Size: 1.65MB</p><hr>";
    ...
    program2[2] = "<hr><p>Application Type: Console | Extension: .exe | Language: C++ | Size: 1.25MB</p><hr>";
    ...
    program1[2] = "<hr><p>Application Type: Console | Extension: .exe | Language: C++ | Size: 1.27MB</p><hr>";
