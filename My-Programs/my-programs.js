...
function getMyPrograms(){
  ...
  program8[1] = "<A href=\"https://www.dropbox.com/s/llgigffb1z2uncf/Encryption.exe?dl=0\" target=\_blank\">Download Link</a><hr>";
  ...
  program7[1] = "<a href=\"https://www.dropbox.com/s/2rvtv3334wbkeya/MCDamage.exe?dl=0\" target=\"_blank\">Download Link</a><hr>";
  ...
  program6[1] = "<a href=\"https://www.dropbox.com/s/nnjqewyllh2gixb/TTT.exe?dl=0\" target=\"_blank\">Download Link</a><hr>";
  ...
  program5[1] = "<a href=\"https://www.dropbox.com/s/k1n9ymigk5zt1xa/br%20Adder.exe?dl=0\" target=\"_blank\">Download Link</a><hr>";
  program5[2] = "<p>Adds &lt;/br&gt; to a HTML file, different logic options are available.</p></div>";
  var program4 = [];
  program4[0] = "<div><h2>Random Winner</h2>";
  program4[1] = "<a href=\"https://www.dropbox.com/s/k31092wqa9zjykf/Random%20Winner.exe?dl=0\" target=\"_blank\">Download Link</a><hr>";
  ...
  program3[1] = "<a href=\"https://www.dropbox.com/s/zzvwpe3tnuu94sb/Colour%20Tester.exe?dl=0\" target=\"_blank\">Download Link</a><hr>";
  ...
  program2[1] = "<a href=\"https://www.dropbox.com/s/j7bonhwbi9xlq6u/ASCII%20Converter.exe?dl=0\" target=\"_blank\">Download Link</a><hr>";
  program2[2] = "<p>This program lets you press any key on the keyboard to view its ASCII value.</p></div>";
  var program1 = [];
  program1[0] = "<div><h2>Paint</h2>";
  program1[1] = "<a href=\"https://www.dropbox.com/s/v5fkka16k39ovhe/Paint.exe?dl=0\" target=\"_blank\">Download Link</a><hr>";
